...
class Salvage:
    ...
    def __init__(self):
        ...
        self.headers = {
            ...
            'Pragma': 'no-cache',
            'Referer': f'https://www.salvagereseller.com/cars-for-sale/type/automobiles/from-year/2023/to-year/2024/page/{self.page1}',
    ...
    def scrape_urls(self):
        ...
        while True:
            ...
            upd_page1 += 25
            headers['Referer'] = f'https://www.salvagereseller.com/cars-for-sale/type/automobiles/from-year/2023/to-year/2023/page/{upd_page1}'
            self.page2 += 25
            # if self.count >= 50:
            #     break
    ...
    def cars_info(self):
        ...
        filename = f"{self.current_folder_path}/Salvage_reseller.csv"
